...
const SYSTEM_PROMPT = [
  ...
  '',
  'หลังเรียก tool แล้ว ใช้ผลลัพธ์ตอบผู้ใช้เป็นภาษาเดียวกับผู้ใช้สั้นๆ ห้ามเผยรายละเอียดเชิงเทคนิค (เช่น roomId, คะแนน similarity, โครงสร้าง JSON) ให้ผู้ใช้โดยไม่จำเป็น',
  '',
  'REMINDER — ทบทวนกฎ 4 ข้อที่ห้ามลืม:',
  ...
  ' • ห้าม markdown: Line เป็น plain text — ห้าม *, **, _, #, ` และห้าม * นำหน้าบรรทัด; ใช้ • สำหรับรายการห้อง',
].join('\n')

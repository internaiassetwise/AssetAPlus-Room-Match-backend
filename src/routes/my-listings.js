...
// Landlords contact admin via Line to list rooms — they never self-list here.
// The endpoint stays mounted so a stale frontend tab that still calls it gets a
// clear 403 instead of a 404 (which would suggest "wrong URL").
myListings.post('/', requireLandlord, asyncHandler(async () => {
  throw new AppError(
    403,
    'CONTACT_ADMIN',
